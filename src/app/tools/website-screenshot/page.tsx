...
export default function WebsiteScreenshotPage() {
  ...
  const handleCapture = () => {
    ...
    const thumbUrl = `https://image.thum.io/get/width/${width}/${encodeURIComponent(targetUrl)}`;
  ...
  return (
    <ToolLayout
      ...
      description="Capture screenshots of any website in different viewport sizes"
