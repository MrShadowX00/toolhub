...
function getStats(text: string): Stat[] {
  ...
  return [
    { labelKey: "words", value: wordCount, icon: <FileText className="h-4 w-4" /> },
    { labelKey: "charsWithSpaces", value: charsWithSpaces, icon: <Type className="h-4 w-4" /> },
    { labelKey: "charsNoSpaces", value: charsNoSpaces, icon: <Space className="h-4 w-4" /> },
    { labelKey: "sentences", value: sentences, icon: <AlignLeft className="h-4 w-4" /> },
    { labelKey: "paragraphs", value: paragraphs, icon: <Hash className="h-4 w-4" /> },
    { labelKey: "readingTime", value: `${readMin} min`, icon: <Clock className="h-4 w-4" /> },
    { labelKey: "speakingTime", value: `${speakMin} min`, icon: <Mic className="h-4 w-4" /> },
    { labelKey: "avgWordLength", value: avgWordLen, icon: <BarChart3 className="h-4 w-4" /> },
  ];
}
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-gray-800 bg-gray-900 p-6">
        <h3 className="mb-3 text-sm font-medium text-gray-400">{t("enterText")}</h3>
        <textarea
          value={text}
